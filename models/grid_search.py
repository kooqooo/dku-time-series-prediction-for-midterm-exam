...
param_grid = {
    ...
    'max_features': ['auto', 'sqrt', 'log2'],   # 각 트리를 분할할 때 고려할 최대 feature 수
}

# 그리드 서치 설정
# from utils.time_wrapper import time_wrapper
from tqdm import tqdm
grid_search = GridSearchCV(estimator=rf, param_grid=param_grid, scoring='neg_mean_absolute_error', cv=5, n_jobs=-1, verbose=1)
